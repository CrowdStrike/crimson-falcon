# Falcon::ResponsesSensorUpdatePolicyV1
...
| **settings** | [**ResponsesSensorUpdateSettingsV1**](ResponsesSensorUpdateSettingsV1.md) |  |  |
...
instance = Falcon::ResponsesSensorUpdatePolicyV1.new(
  cid: null,
  created_by: null,
