...
| [**query_submissions**](FalconxSandbox.md#query_submissions) | **GET** /falconx/queries/submissions/v1 | Find submission IDs for uploaded files by providing an FQL filter and paging details. Returns a set of submission IDs that match your criteria. |
...
begin
  ...
  puts "Error when calling FalconxSandbox->query_submissions: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FalconxSandbox->query_submissions_with_http_info: #{e}"
end
```
