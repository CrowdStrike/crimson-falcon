...
| [**get_vulnerabilities_0**](SpotlightVulnerabilitiesApi.md#get_vulnerabilities_0) | **GET** /spotlight/entities/vulnerabilities/v2 | Get details on vulnerabilities by providing one or more IDs |
| [**query_vulnerabilities_0**](SpotlightVulnerabilitiesApi.md#query_vulnerabilities_0) | **GET** /spotlight/queries/vulnerabilities/v1 | Search for Vulnerabilities in your environment by providing an FQL filter and paging details. Returns a set of Vulnerability IDs which match the filter criteria |
...
begin
  ...
  puts "Error when calling SpotlightVulnerabilitiesApi->get_vulnerabilities_0: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SpotlightVulnerabilitiesApi->get_vulnerabilities_0_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SpotlightVulnerabilitiesApi->query_vulnerabilities_0: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SpotlightVulnerabilitiesApi->query_vulnerabilities_0_with_http_info: #{e}"
end
```
