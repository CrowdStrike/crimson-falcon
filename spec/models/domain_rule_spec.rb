...
# Unit tests for Falcon::DomainRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Falcon::DomainRule do
  let(:instance) { Falcon::DomainRule.new }

  describe 'test an instance of DomainRule' do
    it 'should create an instance of DomainRule' do
      expect(instance).to be_instance_of(Falcon::DomainRule)
    end
  end
