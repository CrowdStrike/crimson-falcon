...
# Unit tests for Falcon::MlExclusionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MlExclusionsApi' do
  before do
  ...
  describe 'test an instance of MlExclusionsApi' do
    it 'should create an instance of MlExclusionsApi' do
      expect(@api_instance).to be_instance_of(Falcon::MlExclusionsApi)
    end
  end
