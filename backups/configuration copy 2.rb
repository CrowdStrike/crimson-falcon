...
Falcon API Client configuration for the CrowdStrike Falcon API
...
module Falcon
  class Configuration
    ...
    # Set this to override the default user agent string.
    # Default to "crowdstrike-crimson/#{VERSION}".
