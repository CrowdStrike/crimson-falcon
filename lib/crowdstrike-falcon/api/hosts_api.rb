...
module Falcon
  class HostsApi
    ...
    # @param ids [Array<String>] The host agentIDs used to get details on
    # @param [Hash] opts the optional parameters
    # @return [Array<(DomainDeviceDetailsResponseSwagger, Integer, Hash)>] DomainDeviceDetailsResponseSwagger data, response status code and response headers
    def get_device_details_with_http_info(ids, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DomainDeviceDetailsResponseSwagger'
    ...
    # @option opts [String] :sort The property to sort by (e.g. status.desc or hostname.asc)
    # @option opts [String] :filter The filter expression that should be used to limit the results
    # @return [Array<(DomainDeviceResponse, Integer, Hash)>] DomainDeviceResponse data, response status code and response headers
    def query_devices_by_filter_scroll_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DomainDeviceResponse'
