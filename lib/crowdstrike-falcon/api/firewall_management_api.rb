...
module Falcon
  class FirewallManagementApi
    ...
    # @option opts [String] :offset Starting index of overall result set from which to return ids.
    # @option opts [Integer] :limit Number of ids to return.
    # @return [Array<(FwmgrMsaQueryResponse, Integer, Hash)>] FwmgrMsaQueryResponse data, response status code and response headers
    def query_firewall_fields_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FwmgrMsaQueryResponse'
    ...
    # @param body [FwmgrApiPolicyContainerUpsertRequestV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(FwmgrMsaReplyMetaOnly, Integer, Hash)>] FwmgrMsaReplyMetaOnly data, response status code and response headers
    def update_policy_container_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FwmgrMsaReplyMetaOnly'
