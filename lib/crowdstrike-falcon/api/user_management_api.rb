...
module Falcon
  class UserManagementApi
    ...
    # @return [DomainMsaUserGrantsResponse]
    ...
    # @option opts [Integer] :limit The maximum records to return. [1-500] (default to 100)
    # @option opts [String] :sort The property to sort by (default to 'role_name|asc')
    # @return [Array<(DomainMsaUserGrantsResponse, Integer, Hash)>] DomainMsaUserGrantsResponse data, response status code and response headers
    def combined_user_roles_v1_with_http_info(user_uuid, opts = {})
      ...
      allowable_values = ["role_id", "role_name"]
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DomainMsaUserGrantsResponse'
    ...
    # @return [DomainMsaEntitiesUsersResponse]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :validate_only Validate of user is allowed, but do not create user. (default to false)
    # @return [Array<(DomainMsaEntitiesUsersResponse, Integer, Hash)>] DomainMsaEntitiesUsersResponse data, response status code and response headers
    def create_user_v1_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DomainMsaEntitiesUsersResponse'
    ...
    # @return [DomainMsaEntitiesRolesResponse]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :cid Customer ID to get available roles for. Empty CID would result in Role IDs for current CID in view.
    # @return [Array<(DomainMsaEntitiesRolesResponse, Integer, Hash)>] DomainMsaEntitiesRolesResponse data, response status code and response headers
    def entities_roles_v1_with_http_info(ids, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DomainMsaEntitiesRolesResponse'
    ...
    def query_user_v1_with_http_info(opts = {})
      ...
      allowable_values = ["assigned_cids", "cid", "first_name", "last_name", "name", "uid"]
      if @api_client.config.client_side_validation && opts[:'filter'] && !allowable_values.include?(opts[:'filter'])
        fail ArgumentError, "invalid value for \"filter\", must be one of #{allowable_values}"
      end
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
      ...
      allowable_values = ["first_name|asc", "first_name|desc", "last_name|asc", "last_name|desc", "name|asc", "name|desc", "uid|asc", "uid|desc"]
      if @api_client.config.client_side_validation && opts[:'sort'] && !allowable_values.include?(opts[:'sort'])
        fail ArgumentError, "invalid value for \"sort\", must be one of #{allowable_values}"
      end
      # resource path
    ...
    # @param body [MsaIdsRequest] Maximum of 5000 User UUIDs can be specified per request.
    # @param [Hash] opts the optional parameters
    # @return [DomainMsaEntitiesUsersResponse]
