...
module Falcon
  class FilevantageApi
    ...
    # @param ids [Array<String>] Comma separated values of change ids
    # @param [Hash] opts the optional parameters
    # @return [Array<(ExternalGetChangesResponse, Integer, Hash)>] ExternalGetChangesResponse data, response status code and response headers
    def get_changes_with_http_info(ids, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ExternalGetChangesResponse'
