...
module Falcon
  class RealTimeResponseAdminApi
    ...
    # @option opts [Integer] :timeout Timeout for how long to wait for the request in seconds, default timeout is 30 seconds. Maximum is 10 minutes. (default to 30)
    # @option opts [String] :timeout_duration Timeout duration for how long to wait for the request in duration syntax. Example, &#x60;10s&#x60;. Valid units: &#x60;ns, us, ms, s, m, h&#x60;. Maximum is 10 minutes. (default to '30s')
    # @option opts [String] :host_timeout_duration Timeout duration for how long a host has time to complete processing. Default value is a bit less than the overall timeout value. It cannot be greater than the overall request timeout. Maximum is &lt; 10 minutes. Example, &#x60;10s&#x60;. Valid units: &#x60;ns, us, ms, s, m, h&#x60;.  (default to 'tiny bit less than overall request timeout')
    ...
    # @param ids [Array<String>] File IDs
    # @param [Hash] opts the optional parameters
    # @return [Array<(BinservclientMsaPFResponse, Integer, Hash)>] BinservclientMsaPFResponse data, response status code and response headers
    def r_tr_get_put_files_with_http_info(ids, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BinservclientMsaPFResponse'
    ...
    # @param ids [Array<String>] File IDs
    # @param [Hash] opts the optional parameters
    # @return [Array<(DomainMsaPFResponseV2, Integer, Hash)>] DomainMsaPFResponseV2 data, response status code and response headers
    def r_tr_get_put_files_v2_with_http_info(ids, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DomainMsaPFResponseV2'
    ...
    # @option opts [Integer] :limit Number of ids to return.
    # @option opts [String] :sort Sort by spec. Ex: &#39;created_at|asc&#39;.
    # @return [Array<(BinservclientMsaPutFileResponse, Integer, Hash)>] BinservclientMsaPutFileResponse data, response status code and response headers
    def r_tr_list_put_files_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BinservclientMsaPutFileResponse'
