...
module Falcon
  class ResponsePoliciesApi
    ...
    # @param body [RequestsCreateRTResponsePoliciesV1] 
    ...
    # @param body [RequestsCreateRTResponsePoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResponsesRTResponsePoliciesV1, Integer, Hash)>] ResponsesRTResponsePoliciesV1 data, response status code and response headers
    def create_rt_response_policies_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResponsesRTResponsePoliciesV1'
    ...
    # @param body [RequestsUpdateRTResponsePoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [ResponsesRTResponsePoliciesV1]
