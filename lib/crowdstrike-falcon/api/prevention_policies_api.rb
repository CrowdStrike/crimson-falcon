...
module Falcon
  class PreventionPoliciesApi
    ...
    # @param body [RequestsCreatePreventionPoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [ResponsesPreventionPoliciesV1]
    ...
    # @param body [RequestsCreatePreventionPoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResponsesPreventionPoliciesV1, Integer, Hash)>] ResponsesPreventionPoliciesV1 data, response status code and response headers
    def create_prevention_policies_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResponsesPreventionPoliciesV1'
    ...
    # @param body [RequestsUpdatePreventionPoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [ResponsesPreventionPoliciesV1]
