...
module Falcon
  class DeviceControlPoliciesApi
    ...
    # @param body [RequestsCreateDeviceControlPoliciesV1] 
    ...
    # @param body [RequestsCreateDeviceControlPoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResponsesDeviceControlPoliciesV1, Integer, Hash)>] ResponsesDeviceControlPoliciesV1 data, response status code and response headers
    def create_device_control_policies_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResponsesDeviceControlPoliciesV1'
    ...
    # @param body [RequestsUpdateDeviceControlPoliciesV1] 
    # @param [Hash] opts the optional parameters
    # @return [ResponsesDeviceControlPoliciesV1]
