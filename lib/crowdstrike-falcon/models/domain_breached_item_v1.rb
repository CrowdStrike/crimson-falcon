...
module Falcon
  class DomainBreachedItemV1
    ...
    def hash
      [company, credentials_ip, credentials_url, display_name, domain, email, financial, hash_type, job_position, location, login_id, name, password, password_hash, password_salt, phone, social, user_id, user_ip].hash
    end
