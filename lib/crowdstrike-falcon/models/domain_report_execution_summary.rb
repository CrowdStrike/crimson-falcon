...
module Falcon
  class DomainReportExecutionSummary
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Falcon::DomainReportExecutionSummary` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Falcon::DomainReportExecutionSummary`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @report_file_reference.nil?
        invalid_properties.push('invalid value for "report_file_reference", report_file_reference cannot be nil.')
      end

      if @result_metadata.nil?
        invalid_properties.push('invalid value for "result_metadata", result_metadata cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @report_file_reference.nil?
      return false if @result_metadata.nil?
    ...
    def hash
      [id, last_updated_on, report_file_reference, result_metadata, status, status_msg].hash
    end
