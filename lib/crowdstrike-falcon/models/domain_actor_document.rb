...
module Falcon
  class DomainActorDocument
    ...
    def hash
      [active, actor_type, capability, created_date, description, ecrime_kill_chain, entitlements, first_activity_date, group, id, image, kill_chain, known_as, last_activity_date, last_modified_date, motivations, name, notify_users, origins, region, rich_text_description, short_description, slug, target_countries, target_industries, thumbnail, url].hash
    end
