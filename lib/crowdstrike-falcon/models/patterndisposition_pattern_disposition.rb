...
module Falcon
  class PatterndispositionPatternDisposition
    ...
    def hash
      [bootup_safeguard_enabled, critical_process_disabled, detect, fs_operation_blocked, handle_operation_downgraded, inddet_mask, indicator, kill_parent, kill_process, kill_subprocess, operation_blocked, policy_disabled, process_blocked, quarantine_file, quarantine_machine, registry_operation_blocked, rooting, sensor_only].hash
    end
