...
module Falcon
  class FwmgrApiRuleCreateRequestV1
    ...
    def hash
      [action, address_family, description, direction, enabled, fields, icmp, local_address, local_port, log, monitor, name, platform_ids, protocol, remote_address, remote_port, temp_id].hash
    end
