...
module Falcon
  class FwmgrMsaAggregateQueryRequest
    ...
    def list_invalid_properties
      ...
      if @min_doc_count.nil?
        invalid_properties.push('invalid value for "min_doc_count", min_doc_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @min_doc_count.nil?
    ...
    def hash
      [date_ranges, field, filter, interval, min_doc_count, missing, name, q, ranges, size, sort, sub_aggregates, time_zone, type].hash
    end
