...
module Falcon
  class DomainMatchedBreachSummaryV1
    ...
    attr_accessor :impacted_domains

    # Where the exposed data event happened
    attr_accessor :impacted_ips
    ...
    def self.openapi_types
      {
        ...
        :'impacted_domains' => :'Array<String>',
        :'impacted_ips' => :'Array<String>',
        :'name' => :'String',
        :'obtained_by' => :'String',
        :'url' => :'String'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'impacted_domains')
        if (value = attributes[:'impacted_domains']).is_a?(Array)
          self.impacted_domains = value
        end
      end

      if attributes.key?(:'impacted_ips')
        if (value = attributes[:'impacted_ips']).is_a?(Array)
          self.impacted_ips = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fields == o.fields &&
          files == o.files &&
          impacted_domains == o.impacted_domains &&
          impacted_ips == o.impacted_ips &&
          name == o.name &&
    ...
    def hash
      [community_name, confidence_level, description, event_date, event_id, exposure_date, fields, files, impacted_domains, impacted_ips, name, obtained_by, url].hash
    end
