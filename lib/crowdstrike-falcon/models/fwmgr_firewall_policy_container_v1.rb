...
module Falcon
  class FwmgrFirewallPolicyContainerV1
    ...
    def hash
      [created_by, created_on, default_inbound, default_outbound, deleted, enforce, is_default_policy, modified_by, modified_on, platform_id, policy_id, rule_group_ids, test_mode, tracking].hash
    end
