  ...
  class ApiScheduledReportV1
    ...
    def self.openapi_types
      {
        ...
        :'expiration_on' => :'Time',
        :'id' => :'String',
        :'last_execution' => :'DomainReportExecutionSummary',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Falcon::ApiScheduledReportV1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Falcon::ApiScheduledReportV1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @trigger_reference.nil?
        invalid_properties.push('invalid value for "trigger_reference", trigger_reference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @trigger_reference.nil?
    ...
    def hash
      [can_write, created_on, customer_id, description, expiration_on, id, last_execution, last_updated_on, name, next_execution_on, notifications, report_params, schedule, shared_with, start_on, status, stop_on, tracking, trigger_reference, type, user_id, user_uuid].hash
    end
