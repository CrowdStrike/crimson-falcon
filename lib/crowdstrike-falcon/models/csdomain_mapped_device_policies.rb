...
module Falcon
  class CsdomainMappedDevicePolicies
    ...
    def self.openapi_types
      {
        ...
        :'device_control' => :'CsdomainDevicePolicy',
        :'firewall' => :'CsdomainDevicePolicy',
        :'global_config' => :'CsdomainDevicePolicy',
        :'netskope' => :'CsdomainDevicePolicy',
        :'prevention' => :'CsdomainDevicePolicy',
        :'remote_response' => :'CsdomainDevicePolicy',
        :'sensor_update' => :'CsdomainDevicePolicy'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Falcon::CsdomainMappedDevicePolicies` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Falcon::CsdomainMappedDevicePolicies`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [airlock, automox, device_control, firewall, global_config, netskope, prevention, remote_response, sensor_update].hash
    end
