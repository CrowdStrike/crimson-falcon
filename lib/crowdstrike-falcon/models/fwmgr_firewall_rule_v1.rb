...
module Falcon
  class FwmgrFirewallRuleV1
    ...
    def hash
      [action, address_family, created_by, created_on, customer_id, deleted, description, direction, enabled, family, fields, icmp, id, local_address, local_port, modified_by, modified_on, monitor, name, platform_ids, protocol, remote_address, remote_port, rule_group, version].hash
    end
