...
module Falcon
  ...
  class ResponsesPreventionPolicyV1
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'String',
        :'ioa_rule_groups' => :'Array<ResponsesIOARuleGroupV1>',
        :'modified_by' => :'String',
        :'modified_timestamp' => :'Time',
        :'name' => :'String',
        :'platform_name' => :'String',
        :'prevention_settings' => :'Array<ResponsesPreventionCategoryV1>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Falcon::ResponsesPreventionPolicyV1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Falcon::ResponsesPreventionPolicyV1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
