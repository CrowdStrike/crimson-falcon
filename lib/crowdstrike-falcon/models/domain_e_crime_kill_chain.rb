...
module Falcon
  class DomainECrimeKillChain
    ...
    def hash
      [attribution, crimes, customers, marketing, monetization, rich_text_attribution, rich_text_crimes, rich_text_customers, rich_text_marketing, rich_text_monetization, rich_text_services_offered, rich_text_services_used, rich_text_technical_tradecraft, rich_text_victims, services_offered, services_used, technical_tradecraft, victims].hash
    end
