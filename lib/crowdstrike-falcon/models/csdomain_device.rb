  ...
  class CsdomainDevice
    ...
    def self.openapi_types
      {
        ...
        :'device_id' => :'String',
        :'device_policies' => :'CsdomainMappedDevicePolicies',
        :'email' => :'String',
        :'external_ip' => :'String',
        ...
        :'managed_apps' => :'CsdomainManagedApps',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Falcon::CsdomainDevice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Falcon::CsdomainDevice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [agent_load_flags, agent_local_time, agent_version, bios_manufacturer, bios_version, build_number, cid, config_id_base, config_id_build, config_id_platform, detection_suppression_status, device_id, device_policies, email, external_ip, first_login_timestamp, first_login_user, first_seen, group_hash, groups, host_hidden_status, hostname, instance_id, last_login_timestamp, last_login_user, last_seen, local_ip, mac_address, machine_domain, major_version, managed_apps, meta, minor_version, modified_timestamp, notes, os_version, ou, platform_id, platform_name, pointer_size, policies, product_type, product_type_desc, provision_status, release_group, service_pack_major, service_pack_minor, service_provider, service_provider_account_id, site_name, slow_changing_modified_timestamp, status, system_manufacturer, system_product_name, tags].hash
    end
