...
module Falcon
  class DomainIncident
    ...
    def hash
      [assigned_to, assigned_to_name, cid, created, description, _end, events_histogram, fine_score, host_ids, hosts, incident_id, incident_type, lm_host_ids, lm_hosts_capped, modified_timestamp, name, objectives, start, state, status, tactics, tags, techniques, users, visibility].hash
    end
