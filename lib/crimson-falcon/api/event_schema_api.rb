...
module Falcon
  class EventSchemaApi
    ...
    def fdrschema_combined_event_get(opts = {})
      data, _status_code, _headers = fdrschema_combined_event_get_with_http_info(opts)
      data
    end
    ...
    def fdrschema_combined_event_get_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SchemaSensorEventResponseV1'
    ...
    # @return [SchemaSensorEventResponseV1]
    def fdrschema_entities_event_get(opts = {})
      data, _status_code, _headers = fdrschema_entities_event_get_with_http_info(opts)
      data
    end
    ...
    def fdrschema_queries_event_get(opts = {})
      data, _status_code, _headers = fdrschema_queries_event_get_with_http_info(opts)
      data
    end
