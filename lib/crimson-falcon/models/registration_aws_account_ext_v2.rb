...
module Falcon
  class RegistrationAWSAccountExtV2
    ...
    def hash
      [account_id, account_type, behavior_assessment_enabled, cloudtrail_region, iam_role_arn, is_master, organization_id, sensor_management_enabled, use_existing_cloudtrail].hash
    end
